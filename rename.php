...
foreach ($it as $path) {
    ...
    $file_contents = str_replace("toolgenerator", $newname, $file_contents); // oldname, newname
    file_put_contents($path_to_file, $file_contents);
}

// file and folder rename procedure
rename("./lang/en/tool_toolgenerator.php", "./lang/en/local_" . $newname . ".php");
rename("../moodle-admintool_toolgenerator", "../" . $newname);
